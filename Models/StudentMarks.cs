...
namespace WebAppPracticeP_07.Models
{
    public class StudentMarks
    {
        string connectionString = "data source=MY_PC;initial catalog=SSchool;integrated security=True;MultipleActiveResultSets=True;";
